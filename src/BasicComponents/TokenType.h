...
namespace TokenTypeUtils {
    ...
    inline bool isOperatorTokenType(TokenType type) {
        return type == TokenType::OPERATOR_ADDITION || type == TokenType::OPERATOR_SUBTRACTION ||
            type == TokenType::OPERATOR_MULTIPLICATION || type == TokenType::OPERATOR_DIVISION ||
            type == TokenType::OPERATOR_DIVISION_REMAINDER || type == TokenType::OPERATOR_LESS_THAN ||
            type == TokenType::OPERATOR_MORE_THAN || type == TokenType::OPERATOR_EQUALS ||
            type == TokenType::OPERATOR_NOT_EQUALS;
    }

    inline bool isAllowedTokenInValueExpression(TokenType type) {
        return type == TokenType::IDENTIFIER || type == TokenType::NUMERICAL_INTEGER_LITERAL ||
            type == TokenType::NUMERICAL_FLOAT_LITERAL || type == TokenType::STRING_LITERAL ||
                type == TokenType::ROUND_OPENING_BRACKET || type == TokenType::ROUND_CLOSING_BRACKET ||
                    type == TokenType::TEXT_VALUE_QUOTE;
    }
